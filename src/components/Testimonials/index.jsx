...
export function Testimonials() {
  return (
    ...
    >
      <CarouselContent>
        <CarouselItem className='md:basis-1/2 lg:basis-1/2 md:pl-10 md:pr-10'>
          <div
          ...
          >
            <div className='bg-[#020203] rounded-lg p-6 px-3 sm:px-6 md:py-10 h-full'>
              <div className=' flex'>
              ...
              <div className='flex items-center gap-6 mt-6 sm:mt-10'>
                ...
                />
                <h6 className='text-xs sm:text-lg font-bold italic text-white'>
                  Saed, Hoojan
                </h6>
              </div>
            </div>
